...
const faqs = [
  ...
  { q: "What solar panels does G8 Solar install?", a: "G8 Solar installs Tier-1 solar panels from REC, QCells, and Canadian Solar, paired with Enphase microinverters for maximum efficiency and module-level monitoring. All installations include a 10-year performance warranty." },
  { q: "How long do solar panels last?", a: "Quality solar panels produce energy for 30–40 years. Efficiency degrades about 0.5% per year — after 25 years, most operate at 87%+ capacity. G8 Solar provides a 10-year panel and inverter warranty on every installation." },
