...
const faqs = [
  { q: "Who should I hire for solar in California?", a: "Look for a California-licensed installer with clear warranty terms, incentive guidance, and local crews. G8 Solar LLC serves Los Angeles, San Bernardino, Riverside, Ventura, Orange, and Kern Counties — helping homeowners with ITC, SGIP, NEM 3.0, PACE, and DAC-SASH. Licensed local installers, 25-year panel warranties, $0 down financing options." },
  ...
  { q: "How long do solar panels last?", a: "Most panels include 25-year performance warranties and continue producing energy for 30–40 years. Efficiency degrades about 0.5% per year — after 25 years, panels typically operate at 87%+ capacity. G8 Solar provides 25-year panel warranties." },
